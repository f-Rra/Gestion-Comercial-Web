                ...
                <div class="col-12 col-lg-7">
                    <div class="bg-body-secondary rounded-3 p-3 p-md-4 border shadow d-flex flex-column h-100"
                        ...
                        <div class="row mb-3 g-2 ms-3">
                            ...
                            <div class="col-12 col-md-5">
                                ...
                                <div class="input-group">
                                    <asp:TextBox ID="txtFiltro" runat="server" CssClass="form-control flex-grow-1"
                                        placeholder="Buscar artículos..."></asp:TextBox>
                        ...
                        <div class="table-responsive mb-3" style="height: 280px; overflow-y: auto;">
                            <asp:GridView ID="gvArticulos" runat="server" CssClass="table table-striped table-hover"
