    ...
    <asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <script>
            ...
            function onRowClick(row, index) {
                ...
                __doPostBack('<%= btnSeleccionar.UniqueID %>', '');
            }
        </script>
                    ...
                    <div class="bg-body-secondary rounded-3 p-3 p-md-4 border shadow d-flex flex-column"
                        ...
                        <div class="table-responsive flex-grow-1 mb-3" style="overflow-y: auto;">
                            <asp:GridView ID="gvStock" runat="server" AutoGenerateColumns="False"
                                ...
                                OnPageIndexChanging="gvStock_PageIndexChanging" OnRowDataBound="gvStock_RowDataBound"
                ...
                <div class="col-12 col-lg-4">
                    <div class="bg-body-secondary rounded-3 p-3 p-md-4 border shadow d-flex flex-column"
                        ...
                        <div class="mb-3">
                            ...
                            <asp:DropDownList ID="ddlOperacion" runat="server" CssClass="form-select form-select-sm"
                                Enabled="false">
        ...
        <asp:LinkButton ID="btnSeleccionar" runat="server" OnClick="btnSeleccionar_Click" Style="display:none;">
        </asp:LinkButton>
