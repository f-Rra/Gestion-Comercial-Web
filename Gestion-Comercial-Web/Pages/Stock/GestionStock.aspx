<%@ Page Title="Gestión de Stock" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionStock.aspx.cs" Inherits="Gestion_Comercial_Web.Pages.Stock.GestionStock" %>
            ...
            <div class="col-12 col-lg-7">
                <div class="bg-body-secondary rounded-3 p-3 p-md-4 border shadow d-flex flex-column h-100"
                    ...
                    <div class="table-responsive flex-grow-1 mb-3" style="min-height: 320px; overflow-y: auto;">
                        <asp:GridView ID="gvStock" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-hover w-100" EmptyDataText="No hay artículos para mostrar" HeaderStyle-BackColor="#012E40" HeaderStyle-ForeColor="White" Style="background-color: var(--color-light);">
                            <Columns>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-end mt-auto gap-2">
                        <div class="d-flex gap-2">
                            <asp:LinkButton ID="btnStockBajo" runat="server" CssClass="btn bg-primary-dark text-light-custom w-100 ms-auto fw-semibold">Stock Bajo</asp:LinkButton>
                        </div>
                        <div class="d-flex gap-2">
                            <asp:LinkButton ID="btnSinStock" runat="server" CssClass="btn bg-primary-dark text-light-custom w-100 ms-auto fw-semibold">Sin Stock</asp:LinkButton>
                        </div>
                        <div class="d-flex gap-2">
                            <asp:LinkButton ID="btnMostrarTodo" runat="server" CssClass="btn bg-primary-dark text-light-custom w-100 ms-auto fw-semibold text-nowrap">Mostrar Todo</asp:LinkButton>
                        </div>
                    </div>
                ...
                <div class="bg-body-secondary rounded-3 p-3 p-md-4 border shadow d-flex flex-column h-100"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <asp:TextBox ID="txtArticuloSeleccionado" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-row gap-2 mt-auto mb-2">
                        <asp:LinkButton ID="btnEjecutar" runat="server" CssClass="btn btn-outline-info text-light-custom w-50">Ejecutar</asp:LinkButton>
