<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Gestion_Comercial_Web.Login"
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center" style="min-height: 100vh; font-size: 18px;">
                    <div class="col-md-5 col-lg-4 col-xxl-4">
                        <!-- Card de Login -->
                        <div class="card shadow-lg bg-light-custom">
                            <div class="card-body p-5">
                                <!-- Logo y Título -->
                                <div class="text-center mb-4">
                                    <img class="img-fluid mb-3" src="Content/Images/login.png" alt="Logo"
                                        style="width: 120px;" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control form-control-lg"
                                        placeholder="Ingresa tu usuario" MaxLength="50"></asp:TextBox>
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox ID="txtContrasena" runat="server" TextMode="Password"
                                        CssClass="form-control form-control-lg" placeholder="Ingresa tu contraseña"
                                        MaxLength="50"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfvContrasena" runat="server"
                                        ControlToValidate="txtContrasena" ErrorMessage="La contraseña es requerida"
                                        CssClass="text-danger small" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </div>
                                ...
                                <div class="d-grid mt-5">
                                    <asp:Button ID="btnIngresar" runat="server" Text="Ingresar"
                                        CssClass="btn btn-lg bg-primary-dark text-light-custom"
